---
description: Stabilize a change after apply - handle bug recovery and UAT signoff before verification
---

Stabilize a change after apply by guiding through bug recovery, UAT signoff, and verification preparation. This command handles post-apply stabilization for changes using the stabilize-workflow schema.
...
- Proactively before testing to ensure change is ready
...
- Can be called multiple times: /opsx-apply → test → /opsx-stabilize (repeat) → /opsx-verify → /opsx-archive
